...
public abstract class Move {
    ...
    public boolean equals(final Object other){
        ...
        return getAttackedPiece() == otherMove.getAttackedPiece() &&
    ...
    public static final class PawnJump extends Move{
        ...
        public Board execute(){
            ...
            for(final Piece piece : this.board.currentPlayer().getActivePieces()){
                if(!this.movedPiece.equals(piece)) boardBuilder.setPiece(piece);
            }
            ...
            boardBuilder.setMoveMaker(this.board.currentPlayer().getAlliance());
    ...
    static abstract class CastleMove extends Move{
        ...
        public Board execute(){
            final Builder boardBuilder = new Builder();
            for(final Piece piece : this.board.currentPlayer().getActivePieces()){
                if(!this.movedPiece.equals(piece) && !this.castleRook.equals(piece)) boardBuilder.setPiece(piece);
            }
            ...
            final Pawn movedPawn = (Pawn)this.movedPiece.movePiece(this);
            boardBuilder.setPiece(this.movedPiece);
